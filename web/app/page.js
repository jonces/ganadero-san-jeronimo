      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-green-400 font-black text-xs tracking-widest uppercase">Software</p>
              <p className="text-white font-black text-sm leading-none">Ganadero <span className="text-green-400">SG</span></p>
            </div>
          </div>
